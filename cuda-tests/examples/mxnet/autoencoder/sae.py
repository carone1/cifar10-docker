...
parser.add_argument('--pretrain-num-iter', type=int, default=2000,
                    help='number of iterations for pretraining.')
parser.add_argument('--finetune-num-iter', type=int, default=5000,
...
if __name__ == '__main__':
    ...
    ae_model.save('/tmp/mnist_pt.arg')
    ae_model.load('/tmp/mnist_pt.arg')
