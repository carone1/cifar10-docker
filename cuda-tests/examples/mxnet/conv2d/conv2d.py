...
train_data = gluon.data.DataLoader(
    gluon.data.vision.MNIST('/tmp/data', train=True, transform=transformer),
    batch_size=opt.batch_size, shuffle=True, last_batch='discard')

val_data = gluon.data.DataLoader(
    gluon.data.vision.MNIST('/tmp/data', train=False, transform=transformer),
...
def train(epochs, ctx):
    ...
    net.save_params('/tmp/mnist.params')
