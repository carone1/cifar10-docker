...
def simple_mnist(tensorboard_logdir=None):
    ...
    data_dir = abs_path # os.path.join(abs_path, "..", "..", "..", "DataSets", "MNIST")

    path = os.path.normpath(os.path.join(data_dir, "dataset/Train-28x28_cntk_text.txt"))
    check_path(path)

    print(path, True, input_dim, num_output_classes)
