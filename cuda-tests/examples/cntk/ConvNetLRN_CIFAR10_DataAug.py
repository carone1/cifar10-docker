...
data_path  = os.path.join(abs_path, "dataset") # os.path.join(abs_path, "..", "..", "..", "DataSets", "CIFAR-10")
...
def convnetlrn_cifar10_dataaug(reader_train, reader_test, epoch_size=50000, max_epochs = 8):
...
if __name__=='__main__':
    ...
    reader_test  = create_reader(os.path.join(data_path, 'train_map.txt'), os.path.join(data_path, 'CIFAR-10_mean.xml'), False)
