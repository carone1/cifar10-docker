...
print("Downloading training input data ..")
...
with tf.Session(config=config) as sess:
    ...
    # assert(acc >= 0.6)
    print("Testing Results:", sess.run(tf.argmax(pred, 1), feed_dict={x: mnist.test.images[:4], keep_prob: 1.}))
